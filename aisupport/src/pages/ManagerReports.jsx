...
import { ticketTrendData, categoryData } from '../data/dummyData';
    ...
    <Layout title="Resolution Reports">
      <div className="space-y-6 slide-in">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { label: 'Total Tickets', value: '25,842', change: '▲ 12.9%' },
            { label: 'Open Tickets', value: '2,154', change: '▼ 8.7%' },
            { label: 'Resolved Tickets', value: '23,688', change: '▲ 14.3%' },
            { label: 'Resolution Rate', value: '91.6%', change: '▲ 2.1%' },
          ].map(m => (
