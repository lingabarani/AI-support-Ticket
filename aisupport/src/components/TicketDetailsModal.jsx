...
export default function TicketDetailsModal({ ticket, onClose, onStatusChange, onAddNote, onAutoResolve }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      <div className="card-glass w-full max-w-3xl rounded-xl border border-purple-400/20">
        ...
        <div className="flex flex-wrap items-center gap-3 border-t border-white/10 p-5">
          ...
          <button type="button" onClick={() => onAutoResolve?.(ticket)} className="rounded-lg border border-emerald-400/30 bg-emerald-400/10 px-4 py-2 text-sm font-semibold text-emerald-100 hover:bg-emerald-400/20">AI Auto-Resolve</button>
