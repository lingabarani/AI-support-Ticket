            ...
            <div className="flex items-start justify-between flex-wrap gap-3">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className={`badge-${ticket.status === 'In Progress' ? 'progress' : ticket.status === 'Pending Customer' ? 'pending' : ticket.status.toLowerCase()}`}>{ticket.status}</span>
                ...
                <p className="text-sm text-slate-400 mt-1">Created At: {ticket.created} · Customer: {ticket.customer}</p>
              </div>
              <div className="flex items-center gap-2">
                <select className="px-3 py-2 text-sm rounded-lg text-slate-300">
                  <option>Update Status</option><option>Resolve</option><option>Escalate</option><option>Pending Customer</option>
                </select>
            ...
            <div className="space-y-4">
              ...
              <div className="card-glow rounded-xl p-5">
                ...
                <p className="text-sm text-slate-300 leading-relaxed mb-4">
                  Hi {ticket.customer}, we reviewed your {ticket.category.toLowerCase()} request. {ticket.ai_suggested_resolution}
                </p>
